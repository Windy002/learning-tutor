          ...
          <div className="px-3 pt-4 pb-3">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <button onClick={toggleSidebar} title="关闭侧栏" className="w-7 h-7 rounded-[9px] flex items-center justify-center text-text-muted hover:text-text-primary hover:bg-active-bg transition-colors">
